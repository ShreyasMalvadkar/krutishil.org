                ...
                <div className="col center">
                  ...
                  >
                    <b>
                      {data.PageTitle}
                      <br />
                      {data.PageTitleMarathi}
                    </b>
                  </NavLink>
                  <span
                    className={data.Update ? "blink-text  p-1 m-1" : ""}
                    style={{
                      backgroundColor: data.Update ? "yellow" : "",
                      border: data.Update ? "2px solid red" : "",
                      borderRadius: data.Update ? "5px" : "",
                      display: blinkingState ? "block" : "none",
                    }}
                  >
                    {data.Update}
                  </span>
